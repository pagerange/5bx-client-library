...
class _5bx {
  ...
  public function __construct() {
	...
	if(!defined('_5BX_API_LOGIN_ID') || !defined('_5BX_API_KEY')) {
		throw new Exception('Please ensure you have configured your login id and api key!');
	}
    $this->login_id = _5BX_API_LOGIN_ID;
    $this->api_key = _5BX_API_KEY;
